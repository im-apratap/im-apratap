...
## What I do
- Build **scalable backends** (REST APIs, architecture, performance, reliability)
- Work with **SQL/NoSQL databases** and production-ready integrations
- Build **Web3 apps on Solana** (Rust/Solana programs + dApp integrations)
- Develop **RAG pipelines** and ship **GenAI features** into real systems
- Containerize & ship with **Docker**, improving **DevOps workflows**

## Current focus
- Building **decentralized applications on Solana**
- Advancing **DevOps workflows** for backend systems
- Exploring the intersection of **AI × Blockchain** (with a security mindset)

## Collaboration
Open to collaborations in:
- **Web3 / Solana ecosystems**
- **AI-powered backend systems**
- **Innovative blockchain + scalable infra projects**
